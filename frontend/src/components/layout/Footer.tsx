        ...
        <div className="container-main py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <form onSubmit={handleSubscribe} className="flex gap-2 w-full md:w-auto">
            <input
              ...
              className="px-4 py-2.5 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/50 outline-none focus:border-white/50 text-sm flex-1 md:w-64 transition-colors"
              required
            />
            <button
              type="submit"
              disabled={subscribeLoading}
              className="px-5 py-2.5 bg-white text-red-700 font-semibold rounded-lg hover:bg-red-50 transition-colors text-sm disabled:opacity-70 whitespace-nowrap"
            >
